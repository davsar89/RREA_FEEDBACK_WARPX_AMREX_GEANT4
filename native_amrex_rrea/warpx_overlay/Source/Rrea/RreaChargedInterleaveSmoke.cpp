...
void exercise_charged_field_half_kick()
{
    ...
    RreaApplyChargedFieldHalfKick(drain, 1.0e-12, -1.0, e3, bx, by, bz);
    ...
    RreaApplyChargedFieldHalfKick(turn, 1.0e-9, -1.0, ee, ex_, ey_, ez_);
    RreaApplyChargedFieldHalfKick(turn, 1.0e-9, +1.0, pe, px, py, pz);
